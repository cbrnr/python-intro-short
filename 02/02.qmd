...
![Python components](python-components.png){width=50%}
...
- To get started with IDLE, check out this very nice [IDLE tutorial](https://realpython.com/python-idle/).

...
A list is a container sequence which, unlike strings, can contain items of *arbitrary* types (even other lists). We use square brackets to create a new list (with commas separating the list items):
